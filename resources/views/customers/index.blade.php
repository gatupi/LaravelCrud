...
">
    ...
    <div style="display: flex; align-items: baseline; justify-content: space-evenly; margin-bottom: 10px;">
        <div class="cms-label-input-box" style="margin: 0;">
            <input value="{{substr($filters['name'], 1, strlen($filters['name'])-2)}}" id="name" name="name" type="text">
        ...
        <div class="cms-age-filter">
            <div class="cms-label-input-box">
                <select class="cms-form-select filter-form-input" name="age_filter_opt" id="age-option" onchange="{
                    var val = this.value;
    ...
    <div style="display: flex; align-items: flex-end; justify-content: space-between; /*background-color: rgb(201, 243, 237);*/">
        <div class="birth-filter slct-filter" style="background-color: rgb(207, 207, 245); margin: 0;">
            <div class="cms-label-input-box">
                <select id="birth-slct" name="birth_filter_opt" class="cms-form-select filter-form-input" onchange="{
                    var val = this.value;
        ...
        <div style="display: flex; flex-direction: column;">
            <button type="reset" style="margin-bottom: 5px; border: 1px solid #555; border-radius: 5px;" onclick="{
